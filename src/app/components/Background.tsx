  ...
  return (
    <div className="absolute w-screen h-screen overflow-hidden md:overflow-visible">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 775" fill="none">
        ...
        <defs>
          ...
          >
            ...
            <feColorMatrix
              type="matrix"
              values="0 0 0 0 0.679808 0 0 0 0 0.388929 0 0 0 0 0.437408 0 0 0 0.97 0"
            />
            <feBlend
              mode="normal"
            ...
            <feGaussianBlur
              stdDeviation="25.45"
              result="effect2_foregroundBlur_1_8"
            />
            <feTurbulence
              type="fractalNoise"
            ...
            <feDisplacementMap
              ...
              height="100%"
            />
            <feMerge result="effect3_texture_1_8">
      ...
      <svg
        ...
        viewBox="0 0 816 786"
        fill="none"
        className="absolute top-0 right-0 md:w-auto md:h-auto w-lvh h-lvh"
      >
        <g filter="url(#filter0_dfg_1_3)">
          <ellipse
            cx="408.016"
            cy="392.717"
            rx="66.0152"
            ry="84.0765"
            transform="rotate(106 408.016 392.717)"
            fill="#63AD9C"
            fillOpacity="0.74"
            shapeRendering="crispEdges"
          />
        ...
        <defs>
          ...
          >
            ...
            <feColorMatrix
              type="matrix"
              values="0 0 0 0 0.492356 0 0 0 0 0.95 0 0 0 0 0.843216 0 0 0 1 0"
            />
            <feBlend
              mode="normal"
              in2="BackgroundImageFix"
            ...
            <feGaussianBlur
              stdDeviation="25.45"
              result="effect2_foregroundBlur_1_3"
            />
            <feTurbulence
              type="fractalNoise"
              baseFrequency="0.016233766451478004 0.016233766451478004"
            ...
            <feDisplacementMap
              ...
              height="100%"
            />
            <feMerge result="effect3_texture_1_3">
              <feMergeNode in="displacedImage" />
            </feMerge>
          </filter>
        </defs>
